  ...
  return (
    <div>
        ...
        <div className="container mx-0 py-0">
          <div className="relative mx-0 w-screen flex flex-nowrap flex-col items-center justify-center">
            ...
            <div className="absolute mx-4 sm:mx-auto w-11/12 sm:w-4/5 md:w-3/5 lg:w-2/5 mt-60 sm:mt-30 md:mt-28 lg:mt-36">
              ...
              <div className="w-full bg-main bg-opacity-80 px-4 sm:px-8 py-4 sm:py-10">
      ...
      <div className="flex justify-center items-center flex-col px-4 md:px-6 xl:px py-9 md:py-12 xl:py-16 text-secondary mt-28 sm:mt-0">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 pt-10 gap-8 divide-y md:divide-y-0 md:divide-x-2">
